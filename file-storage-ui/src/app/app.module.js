...
var file_upload_module_1 = require('./table/file-upload/file.upload.module');
var file_table_module_1 = require('./table/file-table/file.table.module');
var common_module_1 = require('./table/common/common.module');
require('./app.less');
var AppModule = (function () {
  ...
  AppModule = __decorate([
    core_1.NgModule({
      ...
      imports: [
        file_upload_module_1.FSFileUploadModule,
        file_table_module_1.FSFileTableModule,
